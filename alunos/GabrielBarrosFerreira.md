...
- **GitHub:** @GabrielBarrosFerreira
- **Curso e periodo:** Alunos especial, futuro mestrando
- **Linguagem que voce domina melhor:** Python
- **Ja usou Linux no dia a dia?** sim
- **Ja usou Docker?** sim
- **O que voce espera desta disciplina:** Espero conseguir ter uma visao mais pratica sobre como funciona DevOps, de forma que ao final do periodo eu consiga implementar solucoes para fins pessoais e ate implementacoes no meu ambiente de trabalho
...
- **Tempo de restauracao:** quando algo quebrava na apresentacao ou em uso,
  ...
  muito relativo, mas geralmente em horas, no pior dos casos mais de um dia

- **Taxa de falha em mudancas:** que proporcao das entregas quebrou algo que
  antes funcionava?
  Bem baixa, diria que menos de 10% das tasks

### Qual metrica era a pior, e por que

Acredito que o Lead time, pq toda vez que foi necessaria alguma mudanca, era necessario reler e entender aquele codigo e as configs novamente, pq ja tinha saido da cabeca, o que gera muita perda de tempo, pois estamos falando de codigo com muito legado
